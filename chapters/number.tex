...
\subsection{Addition}
\fixnote{In these sections, provide several meanings directly.  Fewer questions for them.}
...
\fixnote{This argument could be improved, as could the corresponding activity.}
...
\fixnote{The following context is confusing.} 
