...
\fixnote{Insert Shep activity A0}
...
\fixnote{Maybe include closure, with problems.}
...
\begin{problems}
\fixnote{Make sure we have the doubling/halving base-two multiplication algorithm.  Connect to multiplication in microprocessors.}

\fixnote{Perhaps also include the Mysterious base-two game.  Or make it an activity.}
\begin{enumerate}
...
\item If you check out Problems~\ref{P:MS} and \ref{P:DS}, you will
  learn about ``scaffolding'' algorithms.  \fixnote{Move this; perhaps remove scaffolding and say partial products instead.}
