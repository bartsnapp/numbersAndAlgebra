...
\fixnote{See October 16 e-mail for fix.}
\begin{itemize}
...
\item  Using your table from above, compute the differences between the number of pieces chewed on successive days (e.g.,  $f(1) - f(0)$, $f(2) - f(1)$, etc.).  What do you notice?  Why does this happen?  \fixnote{Instead, compute $g(6) - g(5)$.  Interpret your result.}
\end{enumerate}
\end{prob}
\fixnote{Maybe fix these two so that the functions are the same on the integers.} 
