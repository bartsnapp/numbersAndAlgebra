...
%
%You can display this definition with the following URL:  http://www.corestandards.org/Math/Content/3/NF/A/1/ 
%
%[Notes:  The code 3.NF.1 means “third grade, number and operations—fractions, standard 1.”  These standards are written for teachers.]  
%
%Step 2.  Introduce the formal definition of rational number and the set of rational numbers, as in the beginning of section2.4.  
%
...
\fixnote{Incorporate LateX comments into teaching notes.}
